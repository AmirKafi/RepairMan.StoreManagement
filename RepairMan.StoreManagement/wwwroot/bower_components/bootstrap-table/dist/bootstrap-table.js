...
!(function (a) {
    ...
    (o.DEFAULTS = {
        ...
        data: [],
        totalField: "total",
        totalPriceFiled: "totalPrice",
        totalPointFiled: "totalPoint",
        dataField: "rows",
        method: "get",
        url: void 0,
        ajax: void 0,
        ...
        pageNumber: 1,
        pageSize: 100,
        pageList: [10, 25, 50, 100,500,5000,10000],
            ...
            if (this.options.locale) {
                ...
                b[0].toLowerCase(),
                    ...
                    a.fn.bootstrapTable.locales[this.options.locale]
                        ...
                        : a.fn.bootstrapTable.locales[b[0]] && a.extend(this.options, a.fn.bootstrapTable.locales[b[0]]);
            }
        }),
        (o.prototype.initContainer = function () {
            (this.$container = a(
                [
                    ...
                    "top" === this.options.paginationVAlign || "both" === this.options.paginationVAlign ? '<div class="fixed-table-pagination" style="clear: both;"></div>' : "",
                    ...
                    "bottom" === this.options.paginationVAlign || "both" === this.options.paginationVAlign ? '<div class="fixed-table-pagination"></div>' : "",
                    "</div>",
                    "</div>",
                ].join("")
            )),
        ...
        (o.prototype.initHeader = function () {
            var b = this,
                d = {},
                e = [];
            (this.header = { fields: [], styles: [], classes: [], formatters: [], events: [], sorters: [], sortNames: [], cellStyles: [], searchables: [] }),
                    ...
                    e.push("<tr>"),
                        ...
                        a.each(g, function (a, f) {
                            var g = "",
                                ...
                                n = f.width;
                            if (
                                (void 0 === f.width || b.options.cardView || ("string" == typeof f.width && -1 !== f.width.indexOf("%") && (m = "%")),
                                f.width && "string" == typeof f.width && (n = f.width.replace("%", "").replace("px", "")),
                                (h = c("text-align: %s; ", f.halign ? f.halign : f.align)),
                                (i = c("text-align: %s; ", f.align)),
                                (k = c("vertical-align: %s; ", f.valign)),
                                (k += c("width: %s; ", (!f.checkbox && !f.radio) || n ? (n ? n + m : void 0) : "36px")),
                                "undefined" != typeof f.fieldIndex)
                            ) {
                                if (
                                    ((b.header.fields[f.fieldIndex] = f.field),
                                    (b.header.styles[f.fieldIndex] = i + k),
                                    (b.header.classes[f.fieldIndex] = l),
                            ...
                            e.push(
                                ...
                                f.checkbox || f.radio ? c(' class="bs-checkbox %s"', f["class"] || "") : l,
                                c(' style="%s"', h + k),
                                ...
                                (g = b.options.escape ? j(f.title) : f.title),
                ...
                !this.options.showHeader || this.options.cardView
                    ...
                    : (this.$header.show(), this.$tableHeader.show(), this.$tableLoading.css("top", this.$header.outerHeight() + 1), this.getCaret(), a(window).on("resize.bootstrap-table", a.proxy(this.resetWidth, this))),
        ...
        (o.prototype.initSort = function () {
            ...
            return this.options.customSort !== a.noop
                ? void this.options.customSort.apply(this, [this.options.sortName, this.options.sortOrder])
                : void (
                      -1 !== f &&
                      ...
                      this.data.sort(function (c, g) {
                          ...
                          return void 0 !== k
                              ...
                              : ((void 0 === i || null === i) && (i = ""),
                                (void 0 === j || null === j) && (j = ""),
                                b.options.sortStable && i === j && ((i = c._position), (j = g._position)),
                                a.isNumeric(i) && a.isNumeric(j) ? ((i = parseFloat(i)), (j = parseFloat(j)), j > i ? -1 * e : e) : i === j ? 0 : ("string" != typeof i && (i = i.toString()), -1 === i.localeCompare(j) ? -1 * e : e));
                      }),
        ...
        (o.prototype.onSort = function (b) {
            ...
            return (
                ...
                this.options.sortName === c.data("field")
                    ...
                    : ((this.options.sortName = c.data("field")), (this.options.sortOrder = "asc" === c.data("order") ? "desc" : "asc")),
        ...
        var sprintf = $.fn.bootstrapTable.utils.sprintf;
            this.$toolbar.find(".bs-bars").children().length && a("body").append(a(this.options.toolbar)),
                ...
                this.options.showPaginationSwitch &&
                    f.push(
                        c(
                            '<button class="btn' + c(" btn-%s", this.options.buttonsClass) + c(" btn-%s", this.options.iconSize) + '" type="button" name="paginationSwitch" aria-label="pagination Switch" title="%s">',
                            this.options.formatPaginationSwitch()
                        ),
                        c('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.paginationSwitchDown),
                        "</button>"
                    ),
                this.options.showRefresh &&
                    f.push(
                        c('<button class="btn' + c(" btn-%s", this.options.buttonsClass) + c(" btn-%s", this.options.iconSize) + '" type="button" name="refresh" aria-label="refresh" title="%s">', this.options.formatRefresh()),
                        c('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.refresh),
                        c(" %s", this.options.formatRefresh()),
                        "</button>"
                    ),
                this.options.showToggle &&
                    f.push(
                        c('<button class="btn' + c(" btn-%s", this.options.buttonsClass) + c(" btn-%s", this.options.iconSize) + '" type="button" name="toggle" aria-label="toggle" title="%s">', this.options.formatToggle()),
                        c('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.toggle),
                        "</button>"
                    ),
                this.options.showColumns &&
                    (f.push(
                        c('<div class="keep-open btn-group" title="%s">', this.options.formatColumns()),
                        '<button type="button" aria-label="columns" class="btn' + c(" btn-%s", this.options.buttonsClass) + c(" btn-%s", this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">',
                        sprintf('<i class="%s %s"></i> ', this.options.iconsPrefix, this.options.icons.columns),
                        sprintf('%s', this.options.formatColumns()),
                ...
                this.options.search &&
                    ...
                    d.off("keyup drop blur").on("keyup drop blur", function (b) {
        ...
        (o.prototype.initPagination = function () {
            ...
            if (
                ...
                m.push(
                    ...
                    this.options.onlyInfoPagination ? this.options.formatDetailPagination(this.options.totalRows) : this.options.formatShowingRows(this.pageFrom, this.pageTo, this.options.totalRows),
                    "</span>"
                ),
                ...
                var r = [
                    c('<span class="btn-group %s">', "top" === this.options.paginationVAlign || "both" === this.options.paginationVAlign ? "dropdown" : "dropup"),
                    '<button type="button" class="btn' + c(" btn-%s", this.options.buttonsClass) + c(" btn-%s", this.options.iconSize) + ' dropdown-toggle" data-toggle="dropdown">',
                ...
                for (
                    a.each(p, function (a, b) {
                        ...
                        m.push(
                            ...
                            '<ul class="pagination' + c(" pagination-%s", this.options.iconSize) + '">',
                            '<li class="page-pre"><a href="#">' + this.options.paginationPreText + "</a></li>"
                        ),
                        this.totalPages < 5 ? ((d = 1), (e = this.totalPages)) : ((d = this.options.pageNumber - 2), (e = d + 4), 1 > d && ((d = 1), (e = 5)), e > this.totalPages && ((e = this.totalPages), (d = e - 4))),
                        this.totalPages >= 6 &&
                            (this.options.pageNumber >= 3 && (m.push('<li class="page-first' + (1 === this.options.pageNumber ? " active" : "") + '">', '<a href="#">', 1, "</a>", "</li>"), d++),
                            this.options.pageNumber >= 4 && (4 == this.options.pageNumber || 6 == this.totalPages || 7 == this.totalPages ? d-- : m.push('<li class="page-first-separator disabled">', '<a href="#">...</a>', "</li>"), e--)),
                    ...
                    m.push('<li class="page-number' + (b === this.options.pageNumber ? " active" : "") + '">', '<a href="#">', b, "</a>", "</li>");
                this.totalPages >= 8 && this.options.pageNumber <= this.totalPages - 4 && m.push('<li class="page-last-separator disabled">', '<a href="#">...</a>', "</li>"),
                    this.totalPages >= 6 &&
                        this.options.pageNumber <= this.totalPages - 3 &&
                        m.push('<li class="page-last' + (this.totalPages === this.options.pageNumber ? " active" : "") + '">', '<a href="#">', this.totalPages, "</a>", "</li>"),
                    m.push('<li class="page-next"><a href="#">' + this.options.paginationNextText + "</a></li>", "</ul>", "</div>");
            }
            this.$pagination.html(m.join("")),
                this.options.onlyInfoPagination ||
                    ...
                    this.options.paginationLoop || (1 === this.options.pageNumber && h.addClass("disabled"), this.options.pageNumber === this.totalPages && i.addClass("disabled")),
            ...
            if (!(a.inArray(b, this.hiddenRows) > -1)) {
                ...
                return (
                    ...
                    i.push(
                        "<tr",
                        c(" %s", p.join(" ")),
                        c(' id="%s"', a.isArray(b) ? void 0 : b._id),
                        c(' class="%s"', k.classes || (a.isArray(b) ? void 0 : b._class)),
                        c(' data-index="%s"', e),
                        c(' data-uniqueid="%s"', b[this.options.uniqueId]),
                        c("%s", n),
                        ">"
                    ),
                    this.options.cardView && i.push(c('<td colspan="%s"><div class="card-views">', this.header.fields.length)),
                    !this.options.cardView && this.options.detailView && i.push("<td>", '<a class="detail-icon" href="#">', c('<i class="%s %s"></i>', this.options.iconsPrefix, this.options.icons.detailOpen), "</a>", "</td>"),
                    a.each(this.header.fields, function (f, n) {
                        var o = "",
                        ...
                        if (!((g.fromHtml && "undefined" == typeof p) || !z.visible || (g.options.cardView && !z.cardVisible))) {
                            if (
                                (z.escape && (p = j(p)),
                                (k = c('style="%s"', m.concat(g.header.styles[f]).join("; "))),
                                b["_" + n + "_id"] && (t = c(' id="%s"', b["_" + n + "_id"])),
                                b["_" + n + "_class"] && (u = c(' class="%s"', b["_" + n + "_class"])),
                                b["_" + n + "_rowspan"] && (w = c(' rowspan="%s"', b["_" + n + "_rowspan"])),
                                b["_" + n + "_colspan"] && (x = c(' colspan="%s"', b["_" + n + "_colspan"])),
                                b["_" + n + "_title"] && (y = c(' title="%s"', b["_" + n + "_title"])),
                                (s = h(g.header, g.header.cellStyles[f], [p, b, e, n], s)),
                                s.classes && (u = c(' class="%s"', s.classes)),
                                s.css)
                            ) {
                                var A = [];
                            ...
                            (q = h(z, g.header.formatters[f], [p, b, e], p)),
                                b["_" + n + "_data"] &&
                                    !a.isEmptyObject(b["_" + n + "_data"]) &&
                                    a.each(b["_" + n + "_data"], function (a, b) {
                                ...
                                z.checkbox || z.radio
                                    ? ((r = z.checkbox ? "checkbox" : r),
                                      (r = z.radio ? "radio" : r),
                                      (o = [
                                          c(g.options.cardView ? '<div class="card-view %s">' : '<td class="bs-checkbox %s">', z["class"] || ""),
                                          "<input" +
                                              c(' data-index="%s"', e) +
                                              c(' name="%s"', g.options.selectItemName) +
                                              c(' type="%s"', r) +
                                              c(' value="%s"', b[g.options.idField]) +
                                              c(' checked="%s"', q === !0 || p || (q && q.checked) ? "checked" : void 0) +
                                              c(' disabled="%s"', !z.checkboxEnabled || (q && q.disabled) ? "disabled" : void 0) +
                                              " />",
                                          g.header.formatters[f] && "string" == typeof q ? q : "",
                                          g.options.cardView ? "</div>" : "</td>",
                                      ].join("")),
                                      (b[g.header.stateField] = q === !0 || (q && q.checked)))
                                    : ((q = "undefined" == typeof q || null === q ? g.options.undefinedText : q),
                                      (o = g.options.cardView
                                          ? ['<div class="card-view">', g.options.showHeader ? c('<span class="title" %s>%s</span>', k, d(g.columns, "field", "title", n)) : "", c('<span class="value">%s</span>', q), "</div>"].join("")
                                          : [c("<td%s %s %s %s %s %s %s>", t, u, k, v, w, x, y), q, "</td>"].join("")),
                                      g.options.cardView && g.options.smartDisplay && "" === q && (o = '<div class="card-view"></div>')),
                                i.push(o);
                        }
                    }),
        ...
        (o.prototype.initBody = function (b) {
            var d = this,
                f = this.getData();
            this.trigger("pre-body", f),
                (this.$body = this.$el.find(">tbody")),
                this.$body.length || (this.$body = a("<tbody></tbody>").appendTo(this.$el)),
                (this.options.pagination && "server" !== this.options.sidePagination) || ((this.pageFrom = 1), (this.pageTo = f.length));
            ...
            g || i.append('<tr class="no-records-found">' + c('<td colspan="%s">%s</td>', this.$header.find("th").length, this.options.formatNoMatches()) + "</tr>"),
                this.$body.html(i),
                b || this.scrollTo(0),
                this.$body
                    ...
                    .on("click dblclick", function (b) {
                        ...
                        if (
                            !f.find(".detail-icon").length &&
                            (d.trigger("click" === b.type ? "click-cell" : "dbl-click-cell", k, n, h, f),
                            d.trigger("click" === b.type ? "click-row" : "dbl-click-row", h, g, k),
                            "click" === b.type && d.options.clickToSelect && m.clickToSelect)
                        ) {
                ...
                this.$selectItem.off("click").on("click", function (b) {
                    ...
                    d.options.maintainSelected &&
                        a(this).is(":radio") &&
                        a.each(d.options.data, function (a, b) {
                            b[d.header.stateField] = !1;
                        }),
                        (f[d.header.stateField] = e),
                ...
                a.each(this.header.events, function (b, c) {
                    if (c) {
                        ...
                        for (var g in c)
                            d.$body.find(">tr:not(.no-records-found)").each(function () {
                                var b = a(this),
            ...
            this.options.pagination && ((i.pageSize = this.options.pageSize === this.options.formatAllRows() ? this.options.totalRows : this.options.pageSize), (i.pageNumber = this.options.pageNumber)),
                (d || this.options.url || this.options.ajax) &&
                    ("limit" === this.options.queryParamsType &&
                        ((i = { search: i.searchText, sort: i.sortName, order: i.sortOrder }),
                        this.options.pagination &&
                            ((i.offset = this.options.pageSize === this.options.formatAllRows() ? 0 : this.options.pageSize * (this.options.pageNumber - 1)),
        ...
        (o.prototype.getCaret = function () {
            ...
            a.each(this.$header.find("th"), function (c, d) {
                a(d)
                    ...
                    .addClass(a(d).data("field") === b.options.sortName ? b.options.sortOrder : "both");
            });
        }),
        ...
        (o.prototype.fitHeader = function () {
            ...
            (this.$header_ = this.$header.clone(!0, !0)),
                ...
                this.$tableHeader.css({ "margin-right": d }).find("table").css("width", this.$el.outerWidth()).html("").attr("class", this.$el.attr("class")).append(this.$header_),
        ...
        (o.prototype.resetFooter = function () {
            ...
            this.options.showFooter &&
                ...
                (!this.options.cardView && this.options.detailView && e.push('<td><div class="th-inner">&nbsp;</div><div class="fht-cell"></div></td>'),
        ...
        (o.prototype.fitFooter = function () {
            ...
            return (
                clearTimeout(this.timeoutFooter_),
                this.$el.is(":hidden")
                    ? void (this.timeoutFooter_ = setTimeout(a.proxy(this.fitFooter, this), 100))
                    : ((c = this.$el.css("width")),
                      (d = c > this.$tableBody.width() ? g() : 0),
                      this.$tableFooter.css({ "margin-right": d }).find("table").css("width", c).attr("class", this.$el.attr("class")),
        ...
        (o.prototype.resetView = function (a) {
            ...
            return this.options.cardView
                ? (this.$el.css("margin-top", "0"), this.$tableContainer.css("padding-bottom", "0"), void this.$tableFooter.hide())
                : (this.options.showHeader && this.options.height ? (this.$tableHeader.show(), this.resetHeader(), (b += this.$header.outerHeight())) : (this.$tableHeader.hide(), this.trigger("post-header")),
                  this.options.showFooter && (this.resetFooter(), this.options.height && (b += this.$tableFooter.outerHeight() + 1)),
                  this.getCaret(),
                  this.$tableContainer.css("padding-bottom", b + "px"),
                  void this.trigger("reset-view"));
        }),
        (o.prototype.getData = function (b) {
            return !this.searchText && a.isEmptyObject(this.filterColumns) && a.isEmptyObject(this.filterColumnsPartial)
                ? b
        ...
        (o.prototype.load = function (b) {
            var c = !1;
        "server" === this.options.sidePagination ? ((this.options.totalRows = b[this.options.totalField]), (this.options.totalPrice = b[this.options.totalPriceFiled]), (this.options.totalPoint = b[this.options.totalPointFiled]) , (c = b.fixedScroll), (b = b[this.options.dataField])) : a.isArray(b) || ((c = b.fixedScroll), (b = b.data)),
                this.initData(b),
                this.initSearch(),
                this.initPagination(),
                this.initBody(c);
        ...
        (o.prototype.remove = function (b) {
            ...
            if (b.hasOwnProperty("field") && b.hasOwnProperty("values")) {
                for (c = e - 1; c >= 0; c--)
                    (d = this.options.data[c]), d.hasOwnProperty(b.field) && -1 !== a.inArray(d[b.field], b.values) && (this.options.data.splice(c, 1), "server" === this.options.sidePagination && (this.options.totalRows -= 1));
        ...
        (o.prototype.toggleRow = function (b, c) {
            ...
            b.hasOwnProperty("index") ? (d = this.getData()[b.index]) : b.hasOwnProperty("uniqueId") && (d = this.getRowByUniqueId(b.uniqueId)),
                d && ((e = a.inArray(d, this.hiddenRows)), c || -1 !== e ? c && e > -1 && this.hiddenRows.splice(e, 1) : this.hiddenRows.push(d), this.initBody(!0));
        }),
    ...
    (a.fn.bootstrapTable = function (b) {
        ...
        (a.fn.bootstrapTable.utils = { sprintf: c, getFieldIndex: e, compareObjects: i, calculateObjectValue: h, getItemField: l, objectKeys: n, isIEBrowser: m }),
        a(function () {
            a('[data-toggle="table"]').bootstrapTable();
            a('[data-toggle="table2"]').bootstrapTable();
            a('[data-toggle="table3"]').bootstrapTable();
            a('[data-toggle="table4"]').bootstrapTable();
            a('[data-toggle="table5"]').bootstrapTable();
            a('[data-toggle="table6"]').bootstrapTable();
        });
})(jQuery);
