...
(function() {
    ...
    var options = {
        ...
        imageIcons: [
            { value: 'assets/image-icon1.svg', content: '<img height="42px" src="/bower_components/JointJS/assets/image-icon1.svg"/>' },
        ...
        portMarkup: [
            { value: '<rect class="port-body" width="24" height="24" x="-10" y="-10"/>', content: 'Rectangle' },
